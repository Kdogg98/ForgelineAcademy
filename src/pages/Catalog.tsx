      ...
      <div className="border-b border-steel-700/60 bg-navy-950/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
          ...
          <p className="text-steel-400 max-w-2xl">
            {courses.length} courses across the four-stage career ladder. Filter by
            stage, access level, and difficulty to find your next course.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          ...
          {STAGES.map((s) => (
            ...
            >
              {STAGE_LABEL[s.key]}
              {s.tier === 'premium' && (
                <span className="ml-1.5 text-premium-400">PRO</span>
              )}
            </button>
          ))}
        </div>
