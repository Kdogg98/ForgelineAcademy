          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14">
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-1">Certificates That Matter</h3>
                  <p className="text-sm text-steel-400 leading-relaxed">
                    Complete a course, pass the quizzes, earn a numbered certificate.
                    Prove competence on the topics that keep plants running.
                  </p>
                </div>
              </div>
            </div>
