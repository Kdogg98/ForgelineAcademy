      ...
      {open && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-md h-full bg-navy-900 border-l border-steel-700/60 shadow-2xl flex flex-col animate-slide-in">
            {/* Header */}
            <div className="flex items-center justify-between px-4 py-3.5 border-b border-steel-700/60 bg-navy-800/60">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-lg bg-rok-500/20 flex items-center justify-center">
              ...
              <div className="flex items-center gap-1">
                {canUseTutor && messages.length > 0 && (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs text-steel-400 hover:text-error-400 hover:bg-error-500/10 transition-colors"
                    title="Clear chat"
                  >
